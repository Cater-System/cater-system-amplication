...
export class OrderResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => Coupon, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "Coupon",
    action: "read",
    possession: "any",
  })
  async coupon(@graphql.Parent() parent: Order): Promise<Coupon | null> {
    const result = await this.service.getCoupon(parent.id);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => Delivery, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "Delivery",
    action: "read",
    possession: "any",
  })
  async delivery(@graphql.Parent() parent: Order): Promise<Delivery | null> {
