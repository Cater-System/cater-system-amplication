...
import { ProductAttributeFindManyArgs } from "../../productAttribute/base/ProductAttributeFindManyArgs";
...
export class ProductControllerBase {
  ...
  async findManyAttributes(
    ...
    const query = plainToClass(ProductAttributeFindManyArgs, request.query);
  ...
  async connectAttributes(
    @common.Param() params: ProductWhereUniqueInput,
    @common.Body() body: ProductAttributeWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      attributes: {
        connect: body,
