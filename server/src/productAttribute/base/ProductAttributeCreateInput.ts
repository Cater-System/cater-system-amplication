...
@InputType()
class ProductAttributeCreateInput {
  @ApiProperty({
    required: false,
    type: String,
  })
  ...
  @ApiProperty({
    required: false,
    type: () =>
      ProductAttributeItemCreateNestedManyWithoutProductAttributesInput,
  })
  @ValidateNested()
  @Type(() => ProductAttributeItemCreateNestedManyWithoutProductAttributesInput)
  @IsOptional()
  @Field(
    () => ProductAttributeItemCreateNestedManyWithoutProductAttributesInput,
    {
...
export { ProductAttributeCreateInput };
