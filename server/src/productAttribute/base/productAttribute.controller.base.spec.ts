...
describe("ProductAttribute", () => {
  ...
  test("POST /productAttributes", async () => {
  ...
  test("GET /productAttributes/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/productAttributes"}/${nonExistingId}`)
  ...
  test("GET /productAttributes/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/productAttributes"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
